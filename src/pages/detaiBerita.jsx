...
const DetailBerita = () => {
  ...
  const paragraphs = splitKontenToParagraphs(berita?.konten);
        ...
        {loading ? (
          ...
          <>
            ...
            >
              ...
              <div className="pt-3">
                <p className="text-[11px] uppercase tracking-wide text-gray-500">
                  {berita.author || "Admin"} /{" "}
                  {formatTanggalIndonesia(berita.created_at)}
                </p>
              </div>
            </div>
            ...
            <div
              data-aos="fade-up"
              data-aos-delay="200"
              className="mx-auto max-w-4xl space-y-4 text-sm leading-7 text-gray-700 md:text-[15px]"
            >
              {paragraphs.length > 0 ? (
